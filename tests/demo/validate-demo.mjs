...
const exactLines = [
  'When something breaks at home, finding the right professional can be slow, uncertain, and difficult to trust.',
  'Fiakto starts with what the customer already has: a photo, a short description, and an approximate location.',
