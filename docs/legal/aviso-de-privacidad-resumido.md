# Aviso de Privacidad Resumido — Fiakto

*(Versión corta para mostrar en el registro/formulario. Enlaza a la [Política de Privacidad](./politica-de-privacidad.md) completa.)*

---

**Antes de continuar, esto es lo que necesitás saber:**

- 📍 **Tu domicilio exacto** solo se muestra al Profesional que elegís, y recién cuando aceptás su presupuesto. Antes de eso, los Profesionales solo ven una zona aproximada.
...
*Este resumen no reemplaza la Política de Privacidad completa, que prevalece en caso de discrepancia.*
